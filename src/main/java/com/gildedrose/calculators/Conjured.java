...
public class Conjured implements GildedRoseCalculator {
    ...
    List<Rule> rules = List.of(
        ...
        new SellDateRule.Builder().updateQualityBy(-4).when(SELL_IN_IS_ZERO).build(),
        new DefaultRule.Builder().updateQualityBy(-2).build()
    );
